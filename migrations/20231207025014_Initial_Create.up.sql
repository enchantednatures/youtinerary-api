...
create type if not exists itinerary_status as enum ('draft', 'published', 'archived');
create type if not exists itinerary_share_type as enum ('editor', 'viewer');
create type if not exists travel_leg_type as enum ('flight', 'train', 'bus', 'car', 'ferry', 'other');
-- create type 
